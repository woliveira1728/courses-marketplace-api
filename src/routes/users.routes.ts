...
import { IsEmailAlready, ValidateRequest, VerifyIsSeller, VerifyToken } from "../middlewares";
...
userRouter.get("/my-courses-for-sale", VerifyToken.execute, VerifyIsSeller.execute, (req, res) => userController.getMyCoursesForSale(req, res));